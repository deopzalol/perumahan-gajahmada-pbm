...
const items = [
  ...
  {
    icon: ShieldCheck,
    title: "Bebas Banjir & Sengketa",
    desc: "Lahan aman, tidak banjir, legalitas jelas.",
  },
  {
    icon: Maximize,
    title: "Tanah Rumah yang Besar",
    desc: "Luas tanah lega untuk taman & ekspansi.",
  },
  ...
  {
    icon: Lightbulb,
    title: "Lampu Jalan Setiap Blok",
    desc: "Penerangan menyeluruh di malam hari.",
  },
    ...
    <section id="fasilitas" className="py-24 bg-background">
      <div className="container mx-auto px-6">
        ...
        <div className="mt-16 rounded-3xl overflow-hidden shadow-[var(--shadow-elegant)]">
          <img
            src={keunggulan}
            alt="12 Keunggulan Rumah Gajah Mada Residence"
            className="w-full"
            loading="lazy"
          />
        </div>
